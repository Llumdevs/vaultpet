/* ============================================================
   ...
   ============================================================ */
export const drops = {
  fallout:  { model: "/models/trident.glb", glow: "#c4d82e", label: "Fallout",   edition: "047 / 300" },
  pokemon:  { model: "/models/cleaver.glb", glow: "#ffd23f", label: "Pokémon",   edition: "agotado" },
  onepiece: { model: "/models/talwar.glb",  glow: "#3d7bff", label: "One Piece", edition: "próximamente" },
};
